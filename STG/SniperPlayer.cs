...
namespace STG
{
    public class SniperPlayer : PlayerOrigin
    {
        //プレイヤーごとの固有値
        private const int moveSpeed = 2;
        private const int ReloadCount = 30;
        private const int BulletSpeed = 10;
        private const int BulletRange = 60;

        public SniperPlayer(Keys right, Keys left, Keys up, Keys down, Keys attack) : base(right, left, up, down, attack)
        {
            Texture = asd.Engine.Graphics.CreateTexture2D("Resources/SniperPlayer.png");
